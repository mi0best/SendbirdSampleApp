...
public class CreateGroupChannelActivity extends AppCompatActivity
    ...
    public static final String EXTRA_NEW_CHANNEL_CUSTOMTYPE = "EXTRA_NEW_CHANNEL_CUSTOMTYPE";
...
//            mNextButton.setEnabled(false);
    ...
    private void createGroupChannel(List<String> userIds, boolean distinct) {
        // HMY. (Assignment 2)
        // Create Channel with parameters including user ids, custom type(my first name).
        GroupChannelParams params = new GroupChannelParams();
        params.addUserIds(userIds);
        params.setDistinct(distinct);
        params.setCustomType("MIYOUNG");
