...
public class GroupChannelListFragment extends Fragment {
    ...
    public void onResume() {
        ...
        SendBird.addChannelHandler(CHANNEL_HANDLER_ID, new SendBird.ChannelHandler() {
            ...
            public void onMessageReceived(BaseChannel baseChannel, BaseMessage baseMessage) {
                ...
                // MYH. (Assignment 4)
                // It will show a notification after receiving a new message from one of my group channels.
                if (PreferenceUtils.getNotifications() == true) {
    ...
    private void refreshChannelList(int numChannels) {
        ...
        // MYH. (Assignment 3)
        // Add a filter for the custom type.
        // If you want to show other custom types, you need to add them to the list.
        List<String> customTypeFilters = new ArrayList<String>();
        customTypeFilters.add("MIYOUNG");
        mChannelListQuery.setCustomTypesFilter(customTypeFilters);
